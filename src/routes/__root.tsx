...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zero to OneShot AI — Continuity-first AI storytelling" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Zero to OneShot AI" },
      { property: "og:title", content: "Zero to OneShot AI — Continuity-first AI storytelling" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:opsz,wght@9..40,500;9..40,700&display=swap",
      },
    ],
  }),
